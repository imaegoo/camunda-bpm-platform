...
public class UserOperationLogAuthorizationTest extends AuthorizationTest {
  ...
  public void testCheckNonePermissionOnHistoricTask() {
    ...
    createGrantAuthorizationWithoutAuthentication(HISTORIC_TASK, taskId, userId, HistoricTaskPermissions.NONE);
  ...
  public void testCheckReadPermissionOnHistoricTask() {
    ...
    createGrantAuthorizationWithoutAuthentication(HISTORIC_TASK, taskId, userId, HistoricTaskPermissions.READ);
